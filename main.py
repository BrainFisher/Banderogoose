...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(bonus.get_width(
    ), WIDTH - bonus.get_width()), -bonus.get_height(), *bonus.get_size())
...
pygame.time.set_timer(CREATE_BONUS, 1100)
...
while playing:
    ...
    if keys[K_UP] and player_rect.top < HEIGHT and player_rect.top > START:
        player_rect = player_rect.move(player_move_up)
    if keys[K_LEFT] and player_rect.left < WIDTH and player_rect.left > START:
